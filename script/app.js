...
const weatherSunsetText = document.querySelector(".weather-current-text");
...
const mapWrapperText = document.querySelector(".map-wrapper-text");
...
function renderWeatherData(weatherData){
    if(false){
        ...
        weatherSunsetText.innerHTML = `${weatherData.current.condition.text}`
        ...
        mapWrapperText.innerText = `${weatherData.location.country}, ${weatherData.location.name}`
...
function renderChart(weatherData){
    ...
    document.querySelector(".chart-wrapper").innerHTML = '<canvas id="myChart" style="box-shadow: inset 0px 0px 15px rgba(159, 101, 189, 0.223); border-radius: 10px; padding: 20px;"></canvas>';
